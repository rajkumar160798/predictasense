...
export const generateForecastPDF = async () => {
  ...
  pdf.setFontSize(30);
  pdf.setTextColor(40);
  pdf.text("PredictAsense Forecast Report", pdf.internal.pageSize.getWidth() / 2, 290, { align: "center" });
  ...
  pdf.text(`The report is generated by PredictAsense AI Engine.`, pdf.internal.pageSize.getWidth() / 2,720, { align: "center" });
