      ...
      <div className="relative z-10 min-h-screen overflow-y-auto">
        <div className="container mx-auto px-4 py-8">
          ...
          <header className="mb-12 text-center">
            ...
            >
              Your comprehensive predictive maintenance solution powered by
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {metrics.map((metric, index) => (
                  ...
                  >
                    ...
                    <p className="text-zinc-400 mb-4">{metric.description}</p>
            ...
            >
              <div className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700 rounded-lg p-8 text-center">
                ...
                <p className="text-zinc-400 mb-8 max-w-2xl mx-auto">
                  Try our demo to see how ProvansIQ can transform your
                  maintenance operations with AI-powered insights and predictive
                  analytics.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <button
                    onClick={() =>
                      window.open(
                        "https://drive.google.com/file/d/19HRSkh0z4p84AIUl5h2p7y-N87qC3MSd/view?usp=sharing",
                        "_blank"
                      )
                    }
                    className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-gray-900 rounded-lg hover:from-yellow-400 hover:to-yellow-500 transition-all flex items-center gap-2 font-semibold shadow-lg hover:shadow-yellow-500/50"
